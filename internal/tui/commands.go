...
// group identifies the subcommand group (e.g. "history", "skill") — used by
// the TUI update loop to route results to the correct list parser.
func cmdSubcommand(agent aiagent.AIAgent, method func(context.Context, string, ...string) (*protocol.CommandResultPayload, error), subcmd string, group string, args ...string) tea.Cmd {
	return func() tea.Msg {
